...
public class User implements Serializable {
    ...
    @XmlTransient
    public Set<Report> getReportSet1() {
        return reportSet1;
    }

    public void setReportSet1(Set<Report> reportSet1) {
        this.reportSet1 = reportSet1;
    }
    ...
    @JsonIgnore
    private Set<Report> reportSet1 =  new HashSet<>();
    @OneToMany(mappedBy = "userId")
    @JsonIgnore
    ...
    public User(Integer id, String firstName, String lastName, String email, String phone, String username, String password, String sex, String userRole) {
        this.id = id;
    ...
    public String toString() {
        return "com.dhp.pojo.User[ id=" + id + " ]";
    }
